...
public class GramaticaPrefija {
    private Gramatica prefija;

    public GramaticaPrefija(String nombre){
         this.prefija = new Gramatica(nombre);
        ...
        */
        ...
        Produccion p14 = new Produccion(new NT("E"), c14);
     ...
     * @return the prefija
     */
    public Gramatica getPrefija() {
        return prefija;
    }

    @Override
    public String toString() {
        return "GramaticaPrefija{" + prefija + '}';
    }
