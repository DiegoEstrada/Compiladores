...
public class GramaticaInfija {
    ...
    public GramaticaInfija(String nombre){
        ...
        c1.add(new Contenido(new NT("T")));
        c1.add(new Contenido(new NT("E_LISTA")));
        
        p.add(new Produccion(new NT("E"), c1));
        //c.clear();
        //                //            //
        
        //          Produccion 2         //
        ArrayList<Contenido> c2 = new ArrayList();
        c2.add(new Contenido(new T("+")));
        c2.add(new Contenido(new NT("T")));
        c2.add(new Contenido(new NT("E_LISTA")));
       
        p.add(new Produccion(new NT("E_LISTA"), c2));
        //c.clear();
        //                //            //
        
        //          Produccion 3         //
        ArrayList<Contenido> c3 = new ArrayList();
        c3.add(new Contenido()); //OJO, MODIFICAR EN UN FUTURO POR UN TERINAL SI HAY PROBLEMAS DE EXCEPCIONES
       
        p.add(new Produccion(new NT("E_LISTA"), c3));
        //c3.clear();
        //                //            //
        
        //          Produccion 4         //
        ArrayList<Contenido> c4 = new ArrayList();
        c4.add(new Contenido(new NT("F")));
        c4.add(new Contenido(new NT("T_LISTA")));
       
        p.add(new Produccion(new NT("T"), c4));
        //c4.clear();
        //                //            //
        ...
        c5.add(new Contenido(new NT("T_LISTA")));
       
        p.add(new Produccion(new NT("T_LISTA"), c5));
        //c5.clear();
        //                //            //
        
        //          Produccion 6         //
        ArrayList<Contenido> c6 = new ArrayList();
        c6.add(new Contenido());
       
        p.add(new Produccion(new NT("T_LISTA"), c6));
        //c6.clear();
        //                //            //
        
        //          Produccion 7         //
        ArrayList<Contenido> c7 = new ArrayList();
        c7.add(new Contenido(new NT("P")));
        c7.add(new Contenido(new NT("F_LISTA")));
        
        p.add(new Produccion(new NT("F"), c7));
        //c7.clear();
        //                //            //
        ...
        p.add(new Produccion(new NT("F_LISTA"), c8));
        //c8.clear();
        //                //            //
        ...
        p.add(new Produccion(new NT("P"), c10));
        //c10.clear();
        //                //            //
